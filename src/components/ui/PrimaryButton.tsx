...
type StickyCTAProps = PrimaryButtonProps & {
  priceLabel?: string;
  priceValue?: string;
};

export function PrimaryButton({ label, onPress, disabled = false, mode = 'light', style }: PrimaryButtonProps) {
...
export function StickyCTA({ label, onPress, priceLabel, priceValue, disabled = false, mode = 'light' }: StickyCTAProps) {
  const colors = getColors(mode);
  return (
