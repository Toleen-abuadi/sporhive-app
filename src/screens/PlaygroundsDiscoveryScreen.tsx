...
import {
  ...
  Venue,
  VenueDuration,
} from '../services/playgrounds/types';
...
export function PlaygroundsDiscoveryScreen() {
  ...
  const [publicUser, setPublicUserState] = useState<PublicUser | null>(null);
  ...
  const handleDurationSelect = useCallback((duration: VenueDuration) => {
                    ...
                    <Chip
                      ...
                      selected={
                        bookingDraft?.slot?.id
                          ...
                          : formatSlotLabel(bookingDraft?.slot || ({} as Slot)) ===
