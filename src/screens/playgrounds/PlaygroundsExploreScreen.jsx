...
const resolvePriceLabel = (venue, t) => {
  ...
  return label ? t('playgrounds.explore.fromPrice', { price: label }) : t('service.playgrounds.common.placeholder');
};
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              ...
              const activityLabel = item?.activity_id
                ? activities.find((activity) => String(activity.id) === String(item.activity_id))?.name
                : t('playgrounds.explore.multiSport');
